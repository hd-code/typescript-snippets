 ...
 */
export declare function testFunc<Args extends any[], Return>(fn: (...args: Args) => Return, cases: [Args, Return][] | {
    [name: string]: [Args, Return];
}): void;
declare type RecursiveArray<Type> = Array<RecursiveArray<Type> | Type>;
export declare function testFuncClose<Args extends any[], Return extends number | RecursiveArray<number>>(fn: (...args: Args) => Return, cases: [Args, Return][] | {
    [name: string]: [Args, Return];
}, delta: number): void;
export {};
