...
describe("csv", () => {
    describe(serialize.name, () => {
        ...
        testCases.forEach(([name, data, string]) => {
            it(name, () => {
                const got = serialize(data);
    ...
    describe(parse.name, () => {
        const testCases: [string, string, any[]][] = [
            ...
            [
                ...
                'page,description,active\r\n"Home, get started",There is no place like 127.0.0.1,\nAbout,"The story of the Company: ""CSV Adventures""",true\nStart,"Ready\nSteady\nGo!"\r\n"Posts, Pages and more","[1,12]",',
                [
                    {
                        page: "Home, get started",
                        description: "There is no place like 127.0.0.1",
        ...
        testCases.forEach(([name, string, want]) => {
            it(name, () => {
                const got = parse(string);
